	...
	class Registro{
		public function registrar($tdocumento, $documento, $nombres, $apellidos, $correo, $password){
			...
			if ($cont == "0") {
				...
				$sql2 = "INSERT INTO usuarios (tipo_documento, documento, nombres, apellidos, correo, password) VALUES ('$tdocumento', '$documento', '$nombres', '$apellidos', '$correo', '$pass_cifrada')";
