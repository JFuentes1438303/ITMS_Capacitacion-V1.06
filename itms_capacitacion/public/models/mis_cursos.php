...
<?php 	
	...
	echo "<div class='col-sm-4 t_centro'>";
		echo "<a href='../models/eliminar_archivo.php?eliminar=".$registro2['id_archivo']."' class='btn btn-sm btn-outline-danger' onclick='return eliminar()' title='Eliminar Archivo'><i class='fas fa-trash-alt'></i></a>";
	echo "</div>";
	echo "</div>";
	}
